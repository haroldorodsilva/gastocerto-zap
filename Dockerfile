...
# Start application (resolve failed migrations, then deploy, then start)
CMD ["sh", "-c", "npx prisma migrate resolve --rolled-back 20251216163324_add_ai_thresholds || true && npx prisma migrate deploy && node dist/main.js"]